...
export default function Home() {
  return (
    <div className="main">
      ...
      <div className="content h-screen min-h-screen over bg-cover bg-center text-white relative pt-[100px] ml-full flex flex-col items-center justify-center overflow-y-scroll">
